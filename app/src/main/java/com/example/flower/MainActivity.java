...
public class MainActivity extends AppCompatActivity {
    ...
    private void inisialisasiView() {
        ...
        btnMawar.setOnClickListener(view -> bukaGaleri(getString(R.string.mawar)));
        btnMelati.setOnClickListener(view -> bukaGaleri(getString(R.string.melati)));
        btnMatahari.setOnClickListener(view -> bukaGaleri(getString(R.string.matahari)));
    }
